...
public class ImpuestoArreglos {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // ser el resultado de una operacion, todas las variables que sean el resultado 
        // de una operacion se inicializan con 0 pues si su valor es desconocido
        // la operacion no se leera y ademas para limpiar la variable con el proposito 
        // de que no traiga basura como valor inicial.
        float precio [] = new float [4], impuesto = .05f, total = 0; // Todas las variables con globales.
        
        for (int i = 0; i < 4; i++){
            // Se recorre con el ciclo for el arreglo int i = 0;
