...
public class ImpuestoArreglos {
    ...
    public static void main(String[] args) throws IOException {
        ...
        float Precio [] = new float[4], Impuesto = .05f, Total = 0;
        // Todas las variables con globales.
        ...
        for (int i = 0; i < 4; i++) {
            ...
            // con el método "parsefloat" que pertenece a la clase de los "Float" y se le asigna a la variable "Precio".
