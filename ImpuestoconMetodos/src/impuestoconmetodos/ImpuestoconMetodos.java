...
public class ImpuestoconMetodos {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // esta es una constante ya tiene deifnido un valor 0.05f, la f se le agrega para especificar que es de tipo
        // flotante y total (variable) inicializada en cero debido a que no se conoce el valor de la variable por ser
        // el resultado de una operacion es decir todas las variables que sean el resultado de una operacion se 
        ...
        float precio; // La variable tiene alcance en el main y en los demas metodos del programa.
        ...
        // Se envia un mensaje para imprimir el total de la variable a la que se le asigno el valor del 
        // total, solo que se manda llamar al metodo "calculo" y se le pasa como parametro la variable "precio"
