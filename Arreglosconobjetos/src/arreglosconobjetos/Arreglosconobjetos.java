...
public class Arreglosconobjetos {
    ...
    public static void main(String[] args) {
        ...
        do { // Ciclo do while la instruccion do significa hacer el programa estara realizando este
            // ciclo hasta que se cumpal la condicion del while 
        ...
        System.out.println("Elige unaopcion");
        ...
        {
            if(Pacientes[i].getEdad()>pacientemayor.getEdad()) //Si la edad qeu se obtiene el arreglo de objetos es
            //mayor a la edad que se obtiene en el objeto pacientemayor entocnes
            {
        ...
        } //inicio esta vacia pues asi se declaro y se le van a gregando el nombre de las personas de cada
 //posicion del arreglo Personas        
        ...
        for( int i = 0; i<Pacientes.length; i++)
        {
            ...
            //Se obtiene el nombre de los pacientes  su edad qeu cumplan con dicha condicion
            }
        }
