...
public class Pilas2 {
    ...
    public static void main(String[] args) {
        ...
        // Se recorre con un ciclo pop al objeto "pila" para ingresar datos en la pila con el método push.
        for (int x = 1; x <= 10; x++) {
            Pila.push (Integer.toString(x));
            // Con la clase Iterator se recorrerán los elementos de la pila y a mostrarla.
        ...
        // Mientras la pila no esta vacía se eliminara cada elemento de la cima con el método pop.
        while (!Pila.empty())
        System.out.println(Pila.pop());
        // Se muestran los elementos de la pila después de haberla vaciado.
